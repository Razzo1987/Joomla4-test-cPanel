						...
						<tbody>
							<?php foreach ($this->updatedList as $i => $value) : ?>
								<tr class="row<?php echo $i % 2; ?>">
									...
									<td>
										<a href="<?php echo Route::_('index.php?option=com_templates&view=template&id=' . (int) $value->extension_id . '&file=' . $value->hash_id); ?>" title="<?php echo Text::_('JACTION_EDIT'); ?>">
                                            <?php $hash_id = base64_decode($value->hash_id); echo $hash_id; ?>
                                        </a>
									</td>
									<td>
